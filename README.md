...
Go to `http://localhost:16686` to search for spans. Traces capture the complete end-to-end trace from FastAPI HTTP/WS requests down to Postgres transactions, Redis commands, and background Celery task spans.
# document-room
